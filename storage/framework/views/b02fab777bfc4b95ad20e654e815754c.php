                    ...
                    <?php $__currentLoopData = $producten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                                ...
                                <div class="product-cell">
                                    ...
                                    <div>
                                        <a href="/product/<?php echo e($product->ProductID); ?>/detail"
                                            class="product-link"><?php echo e($product->Naam); ?></a>
                                        <div style="font-size:12px;color:var(--gray-500);margin-top:1px;">
                                            <?php echo e($product->Aantal); ?> stuks</div>
                                    </div>
                                </div>
                            </td>
                            <td><span
                                    style="font-family:'DM Mono',monospace;font-size:13px;color:var(--gray-700);"><?php echo e($product->Type); ?></span>
                            </td>
                            <td><span class="muted"><?php echo e($product->Locatie); ?></span></td>
                            <td><span class="badge badge-gray"><?php echo e($product->categorie->Naam ?? '-'); ?></span></td>
                            <td>
                                ...
                                <?php elseif($product->gereserveerdAantal > 0): ?>
                                    <span class="badge badge-warning">🟡 Gedeeltelijk (<?php echo e($beschikbaar); ?> vrij)</span>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="actions">
                                    <?php if(Auth::user()->isDocent()): ?>
                                        <a href="/product/<?php echo e($product->ProductID); ?>/edit"

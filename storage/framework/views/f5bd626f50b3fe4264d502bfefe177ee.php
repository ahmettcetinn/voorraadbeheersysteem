    ...
    <div class="container">
        ...
        <div class="card">
            <div class="profiel-header">
                <div class="avatar"><?php echo e(substr($gebruiker->Naam, 0, 1)); ?></div>
                <div class="profiel-info">
                    <h2><?php echo e($gebruiker->Naam); ?></h2>
                    <p><?php echo e($gebruiker->email); ?></p>
                    <?php if($gebruiker->Rol == 'docent'): ?>
            ...
            <div class="info-grid">
                <div class="info-item">
                    <label>Rol</label>
                    <p><?php echo e($gebruiker->Rol); ?></p>
                </div>
                <div class="info-item">
                    <label>Aantal reserveringen</label>
                    <p><?php echo e($reserveringen->count()); ?></p>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $reserveringen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservering): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($reservering->Status); ?></td>
                                <td><?php echo e($reservering->Doel ?? '-'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
            <?php else: ?>
                <p class="geen-reserveringen"><?php echo e($gebruiker->Naam); ?> heeft nog geen reserveringen.</p>
            <?php endif; ?>
        </div>

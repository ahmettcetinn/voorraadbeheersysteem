...
<body>
    ...
    <nav class="nav">
        <a href="/">← Producten</a>
        <a href="/product/<?php echo e($product->ProductID); ?>/detail"><?php echo e($product->Naam); ?></a>
    </nav>

    <div class="container">
        <div class="page-header">
            <div class="page-title">✏️ Product bewerken</div>
            <div class="page-subtitle"><?php echo e($product->Naam); ?></div>
        </div>
        ...
        <div class="card">
            <form action="/product/<?php echo e($product->ProductID); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row" style="margin-top:18px;">
                    <div class="form-group" style="margin-bottom:0;">
                        <label>Aantal</label>
                        <input type="number" name="Aantal" value="<?php echo e($product->Aantal); ?>" required min="0">
                    </div>
                    <div class="form-group" style="margin-bottom:0;">
                        <label>Locatie</label>
                ...
                <div class="form-group">
                    ...
                    <textarea name="Beschrijving"><?php echo e($product->Beschrijving); ?></textarea>
                </div>

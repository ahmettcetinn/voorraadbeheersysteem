...
<head>
    ...
    <title><?php echo e($product->Naam); ?> - Detail</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="card">
            <div class="product-header">
                ...
                <div class="product-info">
                    <h2><?php echo e($product->Naam); ?></h2>

                    <?php if($product->gereserveerdAantal > 0 && $product->gereserveerdAantal < $product->Aantal): ?>
                        <span class="badge badge-gedeeltelijk">
                            🟡 Gedeeltelijk gereserveerd (<?php echo e($product->gereserveerdAantal); ?>/<?php echo e($product->Aantal); ?>)
                        </span>
                    <?php elseif($product->isGereserveerd && $product->gereserveerdAantal >= $product->Aantal): ?>
                        <span class="badge badge-gereserveerd">
                            🔴 Volledig gereserveerd (<?php echo e($product->gereserveerdAantal); ?>)
                        </span>
                    <?php else: ?>
                        <span class="badge badge-beschikbaar">
                            🟢 Volledig beschikbaar (<?php echo e($product->Aantal); ?> stuks)
                        </span>
                    <?php endif; ?>
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <p><?php echo e($product->categorie->Naam ?? '-'); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Locatie</label>
                            <p><?php echo e($product->Locatie); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Voorraad</label>
                            <p><?php echo e($product->Aantal); ?> stuks</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php if($product->Beschrijving): ?>
                <div style="margin-top: 20px; padding: 15px; background-color: #f8f9fa; border-radius: 8px;">
                    ...
                    <p style="margin-top: 8px; line-height: 1.6;"><?php echo e($product->Beschrijving); ?></p>
                </div>
            <?php endif; ?>
                    ...
                    <table class="reserveringen-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $reserveringen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($res->gebruiker->Naam ?? '-'); ?></td>
                                    <td><?php echo e($res->Aantal); ?></td>
                                    <td><?php echo e($res->Datum); ?></td>
                                    <td>
                                        <?php if($res->Status == 'actief'): ?>
                                            <span style="color: #27ae60; font-weight: bold;">● Actief</span>
                                        <?php else: ?>
                                            <span style="color: #e74c3c;"><?php echo e($res->Status); ?></span>
                                        <?php endif; ?>
                                    </td>
                                </tr>
            ...
            <div
                ...
                <?php if(Auth::user()->isDocent()): ?>
                    <a href="/product/<?php echo e($product->ProductID); ?>/edit" class="btn">✏️ Bewerken</a>
                <?php else: ?>

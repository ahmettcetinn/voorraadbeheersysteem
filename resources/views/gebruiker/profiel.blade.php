    ...
    <div class="container">
        ...
        <div class="card card-body">
            <div class="profile-hero">
                <div class="profile-avatar">{{ substr($gebruiker->Naam, 0, 1) }}</div>
                <div>
                    <div class="profile-name">{{ $gebruiker->Naam }}</div>
                    <div class="profile-email">{{ $gebruiker->email }}</div>
                    @if($gebruiker->Rol === 'admin')
                        <span class="badge badge-admin">🔴 Admin</span>
                    @elseif($gebruiker->Rol === 'docent')
        ...
        <div class="card">
            <div class="section-header">
                <div class="section-title">📋 Reserveringen van {{ $gebruiker->Naam }}</div>
            </div>
                    ...
                    <tbody>
                        @foreach($reserveringen as $reservering)
                            <tr>
                                ...
                                <td style="color:var(--gray-700);font-size:13px;">{{ $reservering->Doel ?? '—' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            @else
                <div class="empty">{{ $gebruiker->Naam }} heeft nog geen reserveringen.</div>
            @endif
        </div>
